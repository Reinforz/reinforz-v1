    ...
    {question.options.map((option, answerIndex) => {
      return <div className="Report-Options-container mb-5 p-5 bg-dark pb-0 flex fd-c" key={option.text}>
        <div className="flex jc-sb mb-5 jc-sb">
          ...
          <Markdown classNames={{
            typography: `Report-Options-container-item Report-Options-container-item-text flex-1 bg-light flex ai-c p-10`
          }} content={option.text} />
          {option.isCorrect ? <div className="Report-Options-container-item bg-light flex ai-c jc-c p-5 ml-5"><AiFillCheckSquare fill={green[500]} style={{ padding: 5 }} size={17.5} /></div> : null}
          {option.userSelected ? <div className="Report-Options-container-item bg-light flex ai-c jc-c p-5 ml-5"><FaUser fill={theme.palette.text.primary} style={{ padding: 5 }} size={17.5} /> </div> : null}
        </div>
