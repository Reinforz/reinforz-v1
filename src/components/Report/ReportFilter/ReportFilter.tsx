...
export default function ReportFilter() {
  ...
  return <div className="ReportFilter" style={{ backgroundColor: theme.color.dark }}>
    ...
    <RadioGroup lsKey={"REPORT_FILTERS"} itemLabel={(item) => item === "true" ? "Correct" : item === "false" ? "Incorrect" : "Any"} items={["true", "false", "any"]} label={"Verdict"} setState={setReportFilter} state={reportFilter} stateKey={"verdict"} />
    <RadioGroup lsKey={"REPORT_FILTERS"} items={["0", "1", "2", "3", "any"]} label={"Hints Used"} setState={setReportFilter} state={reportFilter} stateKey={"hints_used"} />
