...
export default function ReportFilter(props: Props) {
  ...
  return <div className="ReportFilter">
    ...
    <Select multiple label={"Excluded Quizzes"} items={selectedQuizIds} menuItemLabel={(item) => item} setState={setReportFilter} state={reportFilter} stateKey={"excluded_quizzes"} />
